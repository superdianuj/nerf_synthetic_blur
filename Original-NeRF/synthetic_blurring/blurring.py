...
if __name__=='__main__':
    ...
    parser.add_argument('--size',type=int,default=60,help='size of blur kernel')
    parser.add_argument('--angle',type=int,default=30,help='direction of blur')
    parser.add_argument('--radius',type=int,default=5,help='radius of lens blur')
    parser.add_argument('--components',type=int,default=4,help='components of lens blur')
    parser.add_argument('--gamma',type=int,default=2,help='exposure gamma for lens blur')
